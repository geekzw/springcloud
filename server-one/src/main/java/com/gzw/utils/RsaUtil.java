...
//    private static final String PUBLIC_KEY = "MIGfMA0GCSqGSIb3DQEBAQUAA4GNADCBiQKBgQCRQZ5O/AOAjeYAaSFf6Rjhqovws78I716I9oGF7WxCIPmcaUa1YuyLOncCCuPsaw69+RMWjdbOBp8hd4PPM/d4mKTOVEYUE0SfxhhDTZaM5CzQEUXUyXy7icQTGR5wBjrbjU1yHCKOf5PJJZZQWB06husSFZ40TdL7FdlBpZ1u1QIDAQAB";
    ...
    private static final String KEY_PATH = "/Users/gujian/ideaProjects/springboot/";
    ...
    public static Map<String,String> getKeys() throws Exception {
        ...
        String publicKeyStr = new String(Base64Utils.encode(publicKey.getEncoded()));
        String privateKeyStr = new String(Base64Utils.encode(privateKey.getEncoded()));
    ...
    private static void createKey(Map<String, String> keyMap){
        String privateKey = keyMap.get(PRIVATE_KEY);
        String publicKey = keyMap.get(PUBLIC_KEY);

        File privateFile = new File(KEY_PATH+PRIVATE_KEY);
        File publicFile = new File(KEY_PATH+PUBLIC_KEY);
        writeToFile(privateKey,privateFile);
        writeToFile(publicKey,publicFile);
    ...
    private static String readFromFileOnly(File file) throws Exception{

        return readFromFile(file);
    }

    private static String readFromFileOrCreate(File file) throws Exception{
    ...
    public static String encryptByPublicKey(String data) throws Exception {
        File file = new File(KEY_PATH+PUBLIC_KEY);
        byte[] dataByte = data.getBytes();
        byte[] keyBytes = Base64Utils.decode(readFromFile(file));
    ...
    public static String decryptByPrivateKey(String data) throws Exception {
        File file = new File(KEY_PATH+PRIVATE_KEY);
    ...
    public static String getPrivateKeyStr()
            throws Exception {
        File file = new File(KEY_PATH+PRIVATE_KEY);
        return readFromFileOnly(file);
    }

    public static String getPrivateKeyStrOrCreate() {
        File file = new File(KEY_PATH+PRIVATE_KEY);
        try {
            return readFromFileOrCreate(file);
        } catch (Exception e) {
            e.printStackTrace();
        }
        return "";
    ...
    public static String getPublicKeyStrOrCreate(){
        File file = new File(KEY_PATH+PUBLIC_KEY);
        try {
            return readFromFileOrCreate(file);
        } catch (Exception e) {
